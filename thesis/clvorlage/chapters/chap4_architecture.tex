...
\begin{examples}
	...
	\item \gll Im tibetischen Buddhismus werden die Dharma-Lehrer/innen gewöhnlich als Lama bezeichnet.
		   PREP ASD ASD ASD ASD ASD ASD ASD ASD ASD ASD ASD 
		\glt 'This is the translation of this sentence.'
	\glend
\end{examples}

\begin{examples}
	\label{ex:multiple-predicates}
	\item Die Pakete werden einzeln weitergeleitet, was manchmal zu unterschiedlichen Pfaden und einer fehlerhaften Übertragung führt.
\end{examples}

whose dependency parse tree is shown in \reffig{fig:example-parzu}:
This sentence has three verbs in it, \textit{werden}, \textit{weitergeleitet}, and \textit{führt}, but only the last two of them are relevant predicates, i.e. predicates that carry ``true'' semantics.
