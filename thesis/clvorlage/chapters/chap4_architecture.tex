...
\fig{images/architecture_grob}{fig:architecture}{General architecture of gliBERT, exemplified for deISEAR task.}{12}{gliBERT Architecture}
...
\fig{images/bert_classification.png}{fig:BERT-classification}{Schema for sentence pair (left) and single sentence (right) classification.}{13}{BERT-Classification}
...
\fig{images/head-cls.png}{fig:CLS-Head}{Head with a one-layer \textbf{F}eed \textbf{F}orward \textbf{N}eural \textbf{N}etwork on the [CLS]-token}{10}{CLS-Head}
...
\fig{images/head-lhsa.png}{fig:Fully-Connected-Feed-Forward-Head}{Head with a one-layer \textbf{F}eed \textbf{F}orward \textbf{N}eural \textbf{N}etwork on the concatenated token sequence.}{10}{Fully-Connected-Feed-Forward-Head}
...
\fig{images/head-gru.png}{fig:GRU-Head}{Head with a one-layer \textbf{F}eed \textbf{F}orward \textbf{N}eural \textbf{N}etwork on the concatenated last hidden states of the bi-directional GRU.}{10}{GRU-Head}
% \section{BLEU Scores}
