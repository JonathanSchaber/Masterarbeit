...
updated by the AdamW optimizer according to the loss, not just BERT's weights.}
...
\fig{images/exampleParzu2.png}{fig:example-parzu}{
  ...
  Information per word is displayed: The normal word form, the CPOSTAG, the POSTAG, the lemma
