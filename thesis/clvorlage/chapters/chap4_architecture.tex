...
role labelling proper. They are usually identified as the main verbs which
...
with multiple predicates. Different Information per word is displayed: Th ``normal'' word form, the
...
\fig{images/num_predarg_structs.pdf}{fig:num-predarg-structs}{Number of predicate-argument structures in all data sets.
                                                              ...
                                                              on average over all datasets, 92.73\% of all sentences have three or less such structures.}{14}{Percentage of Predicate-Argument Structures per Sentence in all Data Sets}
