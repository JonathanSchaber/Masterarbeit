...
This sentence has three verbs in it, \texttt{werden}, \texttt{weitergeleitet}, and \texttt{führt}, but only the last two of them are relevant predicates, i.e. predicates that carry ``true'' semantics.
