...
\fig{images/num_predarg_structs.pdf}{fig:num-predarg-structs}{Number of predicate-argument structures in all data sets.
                                                              ...
                                                              Since it's examples always begin with ``Ich \underline{fühlte} $X$, als ....'',
                                                              ...
                                                              The other curious patterns exhibits SCARE: In no other
                                                              data set the amount of sentences where ParZu couldn't detect any predicates
                                                              is that high.

                                                              Besides the noted peculiarites, it is safe to say that setting the maximum number
                                                              predicate-argument structures to three does probably not lead to much inforation loss;
                                                              on average over all datasets, over 90\% of all sentences have three or less such structures.}{14}{Percentage of Predicate-Argument Structures per Sentence in all Data Sets}
