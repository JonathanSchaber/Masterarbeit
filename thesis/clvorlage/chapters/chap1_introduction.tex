...
NLU aims at building systems which are able to retreive the semantic
...
are expectable fluctations in performance, which makes it highly improbably that only one
