...
token embeddings during the language modeling pretraining is also used in downstream tasks only
...
Following are some example sentences from the PropBank frames\myfootnote{accessible
