...
In the following sentences\myfootnote{Examples are taken from PropBank frames, accessible through this \href{https://github.com/propbank/propbank-frames.git}{GitHub repository}.} are the participants which constitute agents highlighted in
blue:
...
\begin{examples}
  ...
  \item The action followed by one day an Intelogic announcement that it will retain \customcolorbox{[\textsubscript{Arg0} an investment banker]}{blue} to explore alternatives ``to \customcolorbox{[\textsubscript{Rel} maximize]}{llight-blue} \customcolorbox{[\textsubscript{Arg1} shareholder value]}{green},'' including the possible sale of the company.
  \item \customcolorbox{[\textsubscript{Arg0} He]}{blue} \customcolorbox{[\textsubscript{ArgM-mod} would]}{purple} scream and \customcolorbox{[\textsubscript{Rel} cut]}{llight-blue} \customcolorbox{[\textsubscript{Arg1} himself]}{green} \customcolorbox{[\textsubscript{Arg3} with rocks]}{red}.
\end{examples}
