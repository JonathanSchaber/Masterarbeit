...
on what parts of a sentence are the predicates are isolated. To this end, I drop the information about all SRLs,
...
Therefore, the crucial aspect of information the GliBERT heads improve by having access to SRL labels
 lies in their relational character: It is not so much an ``annotation''
