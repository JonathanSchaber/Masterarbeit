...
extreme being SCARE, with its colloquial, short, and often ungrammatical text snippets. Nevertheless,
showing
...
detection tasks. In such cases, an $F_1$-score of course is more meaningful because it
...
results in an accuracy of 59.09\% and a macro $F_1$ of 24.76. The example confusion
