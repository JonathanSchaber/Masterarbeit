...
\fig{images/deISEAR_devtest_new.png}{fig:deISEAR-devtest}{Distribution of emotions in development and test set.}{15}{deISEAR statistics}
...
\fig{images/PAWS-X_devtest_new.png}{fig:PAWS-X-devtest}{Distribution of paraphrases (True) versus non-paraphrases (False) in development and test set.}{15}{PAWS-X statistics}
stats
...
\fig{images/XNLI_devtest.png}{fig:XNLI-stats}{Overview of percentage of stars given. Clearly, there is an imbalance towards giving the full amount of stars possible}{15}{XNLI label statistics}
