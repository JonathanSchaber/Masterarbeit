...
The possible emotions are \textbf{Traurigkeit, Scham, Freude, Angst, Wut, Ekel, Schuld}.\myfootnote{\rotatebox{180}{\ref{itm:deisear1}: Freude, \ref{itm:deisear2}: Scham, \ref{itm:deisear3}: Wut, \ref{itm:deisear4}: Angst}}
...
\begin{figure}
  ...
  \begin{minipage}{0.45\linewidth}
  \vspace{0pt}
    \includegraphics[width=1.0\linewidth]{images/MLQA_context.pdf}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\linewidth}
  \vspace{0pt}
    \includegraphics[width=1.0\linewidth]{images/MLQA_answer.pdf}
  \end{minipage}
  \stepcounter{myfigure}
...
blablabalblabdbasbdabsdbasbdlasdb\myfootnote{\rotatebox{180}{\ref{itm:paws-x1}: False, \ref{itm:paws-x2}: True}}
...
\begin{figure}
  ...
  \begin{minipage}{0.45\linewidth}
  \vspace{0pt}
    \includegraphics[width=1.0\linewidth]{images/PAWS-X_num_examples.pdf}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\linewidth}
  \vspace{0pt}
    \includegraphics[width=1.0\linewidth]{images/PAWS-X_labels.pdf}
  \end{minipage}
  \stepcounter{myfigure}
...
\begin{wrapfigure}{r}{0.45\linewidth}
  \begin{center}
    \includegraphics[width=1.0\linewidth]{images/PAWS-X_BLEU_scores.pdf}
  \end{center}
  \stepcounter{myfigure}
...
\begin{examples}
  \item Ganz okay \textbar\textbar\ Hatte ein Problem mit der APP aber die updates neu installiert und jetzt gehts wieder vorläufig mal Und Ordner wären schön wenn man diese erstellen kann
        ...
        \textbf{Neutral}
        % \hfill\rlap{\hspace*{-5em}\textbf{Neutral}}
  \item Ssssereeehhhr gut

        \textbf{Positive}
        % \hfill\rlNeutralp{\hspace*{-5em}\textbf{Positive}}
  \item Wie kann man so eine gute app machen und dann nicht auf wvga anpassen. Weg mit den matschtexturen und vor allem dem Icon x-(
        % \hfill\rlNeutralp{\hspace*{-5em}\textbf{Negative}}
...
\begin{wrapfigure}{r}{0.45\linewidth}
  \centering
    \includegraphics[width=1.0\linewidth]{images/SCARE_subtokenized.pdf}
  \stepcounter{myfigure}
...
\begin{figure}
  \begin{minipage}{0.45\linewidth}
  \vspace{0pt}
    \includegraphics[width=1.0\linewidth]{images/XQuAD_SRL_normal--24-10-2020_16-52-40_Accuracy.pdf}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\linewidth}
  \vspace{0pt}
    \includegraphics[width=1.0\linewidth]{images/XQuAD_SRL_normal--24-10-2020_16-52-40_Loss.pdf}
  \end{minipage}
  \stepcounter{myfigure}
...
\begin{figure}
  \begin{minipage}{0.45\linewidth}
  \vspace{0pt}
    \includegraphics[width=1.0\linewidth]{images/XQuAD_context.pdf}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\linewidth}
  \vspace{0pt}
    \includegraphics[width=1.0\linewidth]{images/XQuAD_answer.pdf}
  \end{minipage}
  \stepcounter{myfigure}
...
{\begin{tabularx}{\linewidth}{l|lllllX}
  \multirowcell{2}{} & \multirowcell{2}{NLP Task}  & \multirowcell{2}{ML Task}   & \multirowcell{2}{\# Examples\\(Train/Dev/Test)} & \multirowcell{2}{Predefined Splits} & \multirowcell{2}{Domain} & \multirowcell{2}{Remarks} \\ \\ \toprule
  deISEAR            & Emotion Detection           & Multi-Class Classification  & 1001/150/151                                    & -                                   &                          &         \\
  SCARE              & Sentiment Analysis          & Multi-Class Classifiaction  & 1,232/264/264                                   & -                                   &                          &         \\ \hline
  PAWS-X             & Paraphrase Identification   & Binary Classification       & 48,977/1,932/1,967                              & train/dev/test                      & Wikipedia                &         \\
  XNLI               & Natural Language Inference  & Multi-Class Classification  & 2,115/374/5,009                                 & dev/test                            &                          &         \\ \hline
  MLQA               & Question Answering          & Span Prediction             & 432/77/4,499                                    & dev/test                            &                          &         \\
  XQuAD              & Question Answering          & Span Prediction             & 820/181/178                                     & -                                   &                          &
\end{tabularx}
}{Overview data sets}
