...
Besides their carefully, hand-annotated corpus, the authours also provide a dataset comprising of XXX reviews along with the rating --- one to five stars ---, that were available in German on the Google Play Store.
This data set is much larger than the annotated one.
