...
Technically, it is a sequence classification problem: Given a sequqnce of tokens, predict the correct label from a fixed set of emotions.
...
\fig{images/deISEAR_devtest.png}{fig:deISEAR-devtest}{Distribution of emotions in dev set (left) and test set (right).}{14}{deISEAR statistics}
...
\fig{images/PAWS-X_devtest.png}{fig:PAWS-X-devtest}{Distribution of paraphrases (True) versus non-paraphrases (False) in dev set (left) and test set (right).}{14}{PAWS-X statistics}
stats
