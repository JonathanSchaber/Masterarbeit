...
blablabalblabdbasbdabsdbasbdlasdb\myfootnote{\rotatebox{180}{\ref{itm:paws-x1}: False, \ref{itm:itm:paws-x2}: True}}
...
\begin{examples}
  ...
  \item Ssssereeehhhr gut
        \hfill\rlap{\hspace*{-5em}\textbf{Positive}}
  \item Wie kann man so eine gute app machen und dann nicht auf wvga anpassen. Weg mit den matschtexturen und vor allem dem Icon x-(
        \hfill\rlap{\hspace*{-5em}\textbf{Negative}}
