...
well to NLU tasks through few-shot fine-tuning on small task-dependent datasets. Subsequent
...
end, I concatenate BERT embeddings with numerically encoded, automatically generated Semantic
Role Labels (SRLs) as input representation for an end-to-end system on downstream tasks. To
assess semanticity increase, I devise several head architectures and compare the performance
differences of the enriched to the pure embeddings on the GerGLUE dataset comprising various
NLU tasks in German, which I compiled for this thesis. The results indicate that combining
raw, contextualized word embeddings with explicit linguistic information leads to significant
performance increases, suggesting enhanced semanticity capabilities of these representations.
However, dataset and SRL quality are paramount --- translation noise, deficient SRL detection,
and insufficient training data lead to suboptimal model fitting and selection.
