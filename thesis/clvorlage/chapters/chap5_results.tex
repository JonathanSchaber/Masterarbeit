...
\begin{landscape}\centering
  ...
  \tab{tab:results}{Accuracy ensemble results (per 5 models) on single sentence and sentence pair tasks.
                    ...
                    that each results in this table is actually a majority voting out of an ensembeling of fice models.}{
    \scalebox{0.90}{
      \begin{tabular}{llccc|ccc|ccc|ccc|ccc|ccc}
                                                      &           & \multicolumn{18}{c}{\large \textbf{Classification Data Sets}}  \\ \\
                                                      &           & \multicolumn{6}{c|}{\textbf{{[}CLS{]} Head}}                                                                                                                                                                                                                      & \multicolumn{6}{c|}{\textbf{LLOA Head}}                                                                                                                                                                                                & \multicolumn{6}{c}{\textbf{GRU Head}}                                                                                                                                                                                                                           \\ \cline{3-20}
  ...
  \tab{tab:pawsx-beta}{The ``expanded'' PAWS-X $\beta$ results. The light gray line corresponds to the one in table \ref{ref:results}.
    ...
    \scalebox{0.9}{
      \begin{tabular}{lccc|ccc|ccc|ccc|ccc|ccc}
                 ...
                 & \multicolumn{6}{c|}{\textbf{{[}CLS{]} Head}}                                                                                                                                                                                                                      & \multicolumn{6}{c|}{\textbf{LLOA Head}}                                                                                                                                                                                                         & \multicolumn{6}{c}{\textbf{GRU Head}}                                                                                                                                                                                                                           \\ \cline{2-19}
...
\tab{tab:token-vs-merged}{Performance of architectures when BERT subtokenized (yellow) vs. merged (purple).}{
  \scalebox{0.90}{
    \begin{tabular}{llcc|cc|cc|cc}
                                                 &           & \multicolumn{2}{c|}{\textbf{{[}CLS{]} Head}}                                                     & \multicolumn{2}{c|}{\textbf{LLOA Head}}                                                            & \multicolumn{2}{c|}{\textbf{GRU Head}}                                                         & \multicolumn{2}{c}{\textbf{Span Pred. Head}}                                                       \\ \cline{3-10}
                                                 &           & \multicolumn{1}{c|}{zeros}                      & \multicolumn{1}{c|}{dupl.}                     & \multicolumn{1}{c|}{zeros}                        & \multicolumn{1}{c|}{dupl.}                     & \multicolumn{1}{c|}{zeros}                    & dupl.                                          & \multicolumn{1}{c|}{zeros}                       & dupl.                                           \\ \hline\hline
    \multicolumn{1}{c}{\multirow{2}{*}{deISEAR}} & $\alpha$  & \multicolumn{1}{c|}{\cellcolor{yellow} 4.64**}  & \multicolumn{1}{c|}{\cellcolor{purple} .67}    & \multicolumn{1}{c|}{\cellcolor{yellow} 4.63*}     & \multicolumn{1}{c|}{\cellcolor{purple} 1.32}   & \multicolumn{1}{c|}{\cellcolor{yellow} 4.63*} & \multicolumn{1}{c|}{\cellcolor{yellow} 2.65}   & \multicolumn{1}{c|}{\cellcolor{llight-gray}}     & \multicolumn{1}{c}{\cellcolor{llight-gray}}     \\
    \multicolumn{1}{c}{}                         & $\beta$   & \multicolumn{1}{c|}{\cellcolor{yellow} 3.97*}   & \multicolumn{1}{c|}{\cellcolor{yellow} 1.98}   & \multicolumn{1}{c|}{\cellcolor{purple} 5.30*}     & \multicolumn{1}{c|}{\cellcolor{purple} .66}    & \multicolumn{1}{c|}{\cellcolor{yellow} 4.63*} & \multicolumn{1}{c|}{\cellcolor{purple} 2.64}   & \multicolumn{1}{c|}{\cellcolor{llight-gray}}     & \multicolumn{1}{c}{\cellcolor{llight-gray}}     \\ \cline{3-10}
    \multicolumn{1}{c}{\multirow{2}{*}{SCARE}}   & $\alpha$  & \multicolumn{1}{c|}{\cellcolor{purple} 1.13}    & \multicolumn{1}{c|}{\cellcolor{purple} 1.90}   & \multicolumn{1}{c|}{\cellcolor{yellow} 2.27*}     & \multicolumn{1}{c|}{\cellcolor{purple} .38}    & \multicolumn{1}{c|}{\cellcolor{purple} .76}   & \multicolumn{1}{c|}{\cellcolor{yellow} .38}    & \multicolumn{1}{c|}{\cellcolor{llight-gray}}     & \multicolumn{1}{c}{\cellcolor{llight-gray}}     \\
...
\tab{tab:wo-qa-token-vs-merged}{Performance of architectures when BERT subtokenized (yellow) vs. merged (purple). Without QA.}{
  \scalebox{0.90}{
    \begin{tabular}{llcc|cc|cc}
                                                 &           & \multicolumn{2}{c|}{\textbf{{[}CLS{]} Head}}                                                     & \multicolumn{2}{c|}{\textbf{LLOA Head}}                                                            & \multicolumn{2}{c}{\textbf{GRU Head}}                                                           \\ \cline{3-8}
...
\tab{tab:configs}{The different hyperparameter configurations for each data set.}{
  \scalebox{0.9}{
    \begin{tabular}{ll|ccccc}
                                                   &             & number of epochs                       & set set up                             & batch size                               & maximum length                 & SRL implementation        \\ \hline
    \multicolumn{1}{c}{\multirow{2}{*}{deISEAR}}   &  $\alpha$   & 100                                    & 100                                    & 50                                       & 50                             & 20                        \\
    \multicolumn{1}{c}{}                           &  $\beta$    & 100                                    & 100                                    & 50                                       & 50                             & 20                        \\
    \multicolumn{1}{c}{\multirow{2}{*}{SCARE}}     &  $\alpha$   & -                                      & -                                      & -                                        & -                              & asdasd                    \\
    \multicolumn{1}{c}{}                           &  $\beta$    & -                                      & -                                      & -                                        & -                              & asdasd                    \\ \hline
    \multicolumn{1}{c}{\multirow{2}{*}{PAWS-X}}    &  $\alpha$   & 16                                     & 16                                     & 16                                       & 16                             & 16                        \\
    \multicolumn{1}{c}{}                           &  $\beta$    & 16                                     & 16                                     & 16                                       & 16                             & 16                        \\
    \multicolumn{1}{c}{\multirow{2}{*}{XNLI}}      &  $\alpha$   & \colorbox{blue}{40}                    & \colorbox{blue}{200}                   & \colorbox{blue}{50}                      & \colorbox{blue}{100}           & 100                       \\
    \multicolumn{1}{c}{}                           &  $\beta$    & \colorbox{blue}{40}                    & \colorbox{blue}{200}                   & \colorbox{blue}{50}                      & \colorbox{blue}{100}           & 100                       \\ \hline
    \multicolumn{1}{c}{\multirow{2}{*}{MLQA}}      &  $\alpha$   & \colorbox{blue}{40}                    & \colorbox{blue}{200}                   & \colorbox{blue}{50}                      & \colorbox{blue}{100}           & 100                       \\
...
\tab{tab:gain-loss}{Ensemble percentage points gains (positive numbers) / losses (negative numbers) for +SRL
                      ...
                      \tikz[baseline=(char.base)]\node[minimum width=2em,text height=1.2ex, text depth=0.1ex,fill=blue,text=black](char){zeros};,
                      \tikz[baseline=(char.base)]\node[minimum width=2em,text height=1.2ex, text depth=0.1ex,fill=dark-blue,text=black](char){duplicate};.
                      Light blue denotes that both architectures performed
                      \tikz[baseline=(char.base)]\node[minimum width=2em,text height=1.2ex, text depth=0.1ex,fill=llight-blue,text=black](char){equally};
...
\tab{tab:confusion-scare}{Confusion matrix for SCARE $\alpha$ merged, +SRL duplicated.}{
  \begin{tabular}{l|ccc}
...
\tab{tab:qa-gain-loss}{Ensemble percentage points gains (positive numbers) / losses (negative numbers) for +SRL
                       over $-$SRL for the Span Prediction Head from table \ref{tab:results-qa}. The better of the +SRL configurations was taken into
                       account: \tikz[baseline=(char.base)]\node[minimum width=2em,text height=1.2ex, text depth=0.1ex,fill=blue,text=black](char){zeros};,
                       \tikz[baseline=(char.base)]\node[minimum width=2em,text height=1.2ex, text depth=0.1ex,fill=dark-blue,text=black](char){duplicate};.
                       Light blue denotes that both architectures performed \tikz[baseline=(char.base)]\node[minimum width=2em,text height=1.2ex, text depth=0.1ex,fill=llight-blue,text=black](char){equally};
...
\tab{tab:pawsx-abla}{Ablation on Effect of PREDs and ARGs isolated. note that PRED/ARG SRL not significant (SCARE, XNLI ARGs almost, ca. 11\%)}{
  \scalebox{0.9}{
    ...
    deISEAR $\alpha$ & LLOA Head subtok. zeros       & \multicolumn{1}{c|}{\textit{70.86}}          & \multicolumn{1}{c}{72.19}              & \multicolumn{1}{c}{\underline{75.50**}} & \multicolumn{1}{c}{\textbf{77.48**}}  \\
