...
which explicitly handles such a problem, e.g. spam detection tasks. In such
cases, an F1-score of course is more meaningful because it is more sensible to
...
drastic class imbalance. To further substantiate this, I compute some metrics
...
experiment is shown in table \ref{tab:confusion-scare}: Although the algorithm
overpredicts the majority (``Positive'') class, it also predicts to some extent
...
The reportings of the results for the question answering data sets follows the line that was taken
