...
\definecolor{llight-gray}{gray}{0.95}
\definecolor{light-blue}{HTML}{C6DBEF}
\definecolor{llight-blue}{RGB}{222, 235, 247}
\definecolor{blue}{RGB}{158, 202, 225}
\definecolor{dark-blue}{RGB}{49, 130, 189}

\definecolor{yellow}{HTML}{FEB24C}
\definecolor{light-yellow}{HTML}{FED976}
\definecolor{purple}{HTML}{9E9aC8}
